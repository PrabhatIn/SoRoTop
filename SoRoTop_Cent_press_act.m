function SoRoTop_Cent_press_act(nelx,nely,volfrac,sefrac,penal,rmin,ks,etaf,betaf,lst,betamax,delrbst,maxit)
...
fixedUdofs = [2*Bnode(1)-1  2*Bnode(1)  2*Bnode(end)-1 2*Bnode(end) Tnode(1)*2]; %fixed displ.
